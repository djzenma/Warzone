...
public class MapEditor extends Phase {
    ...
    public void showCommands() {
        d_gameEngineController.d_mapView.showAvailableCommands(true);
    }
    ...
    @Override
    public void exit() {
        d_gameEngineController.setPhase(new GamePlayPhase(d_gameEngineController));
    }
    ...
    private LinkedHashMap<String, String> checkAllFilesValidation(String[] p_allFileNames) throws IOException {
        ...
        LinkedHashMap<String, ContinentModel> l_currentContinents = d_gameEngineController.d_mapModel.getContinents();
        LinkedHashMap<String, CountryModel> l_currentCountries = d_gameEngineController.d_mapModel.getCountries();
        ...
        try {
            ...
            for (String l_allFileName : p_allFileNames) {
                ...
                d_gameEngineController.d_mapModel.loadMap(l_mapFile);
                d_gameEngineController.d_mapModel.validateMap();
                l_allFilesValidation.put(l_mapFile.getName(), d_gameEngineController.d_mapModel.isMapValid() ? "Valid" : "Invalid");
            }
        } catch (Exception l_e) {
        ...
        d_gameEngineController.d_mapModel.setContinents(l_currentContinents);
        d_gameEngineController.d_mapModel.setCountries(l_currentCountries);
